    ...
    <div className="landing">
      <header className="hero">
        <div className="hero-inner">
          <div className="hero-left">
            <div className="badge">AI-Powered Complaint System</div>
            <h1>AI That Files Complaints For You — In Your Language</h1>
            <p className="lead">NyayaBharat converts voice notes into official complaints through Telegram.</p>
            <div className="hero-ctas">
              <button className="btn primary" onClick={() => onNavigate?.('voice')}><img src={telegramIcon} alt="" className="btn-icon" /> Start Filing Now</button>
      ...
      <section className="features">
        ...
        <div className="feature-grid">
          <div className="feature"> <img src={micIcon} alt="Voice" className="feature-icon" /> <h4>Voice Complaint Filing</h4> <p>Simply send a voice note in your language; AI converts speech to text and formats it properly.</p></div>
          <div className="feature"> <img src={searchIcon} alt="Legal Lens" className="feature-icon" /> <h4>Legal Lens</h4> <p>AI analyzes your complaint and suggests relevant laws, articles, and frameworks to strengthen your case.</p></div>
          <div className="feature"> <img src={shieldIcon} alt="Officer Mode" className="feature-icon" /> <h4>Officer Mode</h4> <p>Government officials can process multiple complaints efficiently with AI-powered categorization and routing.</p></div>
          <div className="feature"> <img src={chatIcon} alt="Rights Chatbot" className="feature-icon" /> <h4>Rights Chatbot</h4> <p>Get instant answers about your rights, complaint procedures, and government services in simple language.</p></div>
        </div>
      </section>
      ...
      <section className="cta-block">
        ...
        <button className="btn primary large glowing"><img src={telegramIcon} alt="" className="btn-icon" /> Start Filing Now</button>
      </section>
    </div>
  )
}